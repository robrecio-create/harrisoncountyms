...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on HarrisonCountyMS.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'HarrisonCountyMS.com <noreply@contact.harrisoncountyms.com>',
          to: ['hello@harrisoncountyms.com'],
          subject: `New Claim Request: ${business.title} — HarrisonCountyMS.com`,
          reply_to: email,
          text: emailBody,
        }),
